...
export async function GET() {
    const events: EventsResponse['events'] = [
        { tileId: 1,  type: 'neighbor', effect: 'right_plus', amount: 300 },
        { tileId: 2,  type: 'money_minus',  amount: 1000 },
        { tileId: 3,  type: 'money_plus', amount: 500 },
        { tileId: 4,  type: 'money_plus', amount: 500 },
        { tileId: 5,  type: 'money_minus',  amount: 1000 },
        { tileId: 6,  type: 'gamble',   min: -2000, max: 2000 },
        { tileId: 7,  type: 'money_minus', amount: 500 },
        { tileId: 8,  type: 'money_plus',  amount: 1000 },
        { tileId: 9,  type: 'global',   effect: 'all_plus', amount: 500 },
        { tileId: 10, type: 'money_plus',  amount: 1000 },
        { tileId: 11, type: 'money_minus', amount: 500 },
        { tileId: 12, type: 'neighbor', effect: 'right_plus', amount: 300 },
        { tileId: 13, type: 'money_minus', amount: 500 },
        { tileId: 14, type: 'money_minus',  amount: 1000 },
    ]
