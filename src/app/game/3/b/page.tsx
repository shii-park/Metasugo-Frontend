    ...
    <div className="relative w-full h-[100dvh] bg-brown-light grid place-items-center">
      <div className="relative aspect-[16/9] w-[min(100vw,calc(100dvh*16/9))] overflow-hidden">
        ...
        >
          ...
          <Tile col={5} row={5} colorClass={colorClassOfEvent(byId.get(2)?.type)} />
          <Tile col={3} row={5} colorClass={colorClassOfEvent(byId.get(3)?.type)} />
          <Tile col={1} row={5} colorClass={colorClassOfEvent(byId.get(4)?.type)} />

          <Tile col={1} row={3} colorClass={colorClassOfEvent(byId.get(5)?.type)} />
          <Tile col={3} row={3} colorClass={colorClassOfEvent(byId.get(6)?.type)} />
          <Tile col={5} row={3} colorClass={colorClassOfEvent(byId.get(7)?.type)} />
          <Tile col={7} row={3} colorClass={colorClassOfEvent(byId.get(8)?.type)} />
          <Tile col={9} row={3} colorClass={colorClassOfEvent(byId.get(9)?.type)} />
